...
const Page5 = () => {
    ...
    return (
        <div className="w-screen h-screen flex justify-center items-center">
            <div className="flex flex-col items-center justify-around w-screen h-screen Main-color Oregano" style={{ backgroundImage: `url(${background3})`, backgroundRepeat: 'no-repeat', backgroundSize: 'cover', backgroundPositionX: 'center', backgroundPositionY: window.innerWidth < 1024 ? 'center' : -500 }} >
                <div className="w-full h-full p-4" >
                    <div className="w-full h-full background-transparent" >
                        ...
                        <div className="md:h-2/4 h-3/6 Italianno px-10" style={{ overflow: 'auto', fontWeight: '500' }} >
                            {data.map((item) => (
                        ...
                        <div className="md:h-1/3 h-1/5 px-10" >
                            <div className="bg-white h-full w-full px-10 text-14 Italianno Black-color" >
                                <p className="Italianno Black-color" >From : <span><input type="text" placeholder={nama === "" ? "..." : nama} value={nama} onChange={(e) => setNama(e.target.value)} /></span></p>
